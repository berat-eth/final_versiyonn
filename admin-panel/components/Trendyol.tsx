...
import { AlertTriangle, ShoppingCart, Package, BarChart3, Settings, Wand2 } from 'lucide-react'
...
export default function Trendyol() {
  ...
  const actions = [
    { id: 'orders', title: 'Gelen Siparişler', icon: ShoppingCart, color: 'from-orange-500 to-orange-600' },
    { id: 'products', title: 'Ürünler', icon: Package, color: 'from-blue-500 to-blue-600' },
    { id: 'analytics', title: 'Analitik', icon: BarChart3, color: 'from-purple-500 to-purple-600' },
    { id: 'settings', title: 'Ayarlar', icon: Settings, color: 'from-slate-500 to-slate-600' },
  ]

  const handleClick = (title: string) => {
    setOpen({ visible: true, title })
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Trendyol</h1>
