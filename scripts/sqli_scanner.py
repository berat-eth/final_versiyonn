...
def run_scan():
    ...
    BASE_URL = os.environ.get('API_BASE_URL', 'https://api.huglutekstil.com')
    TIMEOUT = float(os.environ.get('SQLI_TIMEOUT', '8.0'))
    SERVER_JS = os.environ.get('SERVER_JS_PATH', r'C:\Users\Lenovo\Desktop\vio\Yeni klasör\final_versiyonn\server\server.js')
